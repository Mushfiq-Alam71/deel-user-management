...
const Contactus = () => {
   return (
      <div className='pt-16 '>
         <section className="p-6 dark:bg-gray-100 rounded-xl">
            <form noValidate="" action="" className="container flex flex-col mx-auto space-y-12">
               <fieldset className="grid grid-cols-4 gap-6 p-6 rounded-xl shadow-sm dark:bg-gray-50">
                  ...
                  <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3" >
                     ...
                     <div className="col-span-full" >
                        ...
                        <div className="flex items-center space-x-2" >
                           <button type="submit" className="px-4 py-2 border rounded-md dark:border-gray-800">Submit</button>
                        </div>
                     </div>
                  </div>
               </fieldset>
